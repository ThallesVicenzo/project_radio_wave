...
class RequestGenericError extends RequestError {
...
class RequestClientError extends RequestError {
  final String? errorMessage;
  final int? errorCode;
  final StackTrace? stackError;
...
class RequestMinorError extends RequestError {
  RequestMinorError({
...
class InstabilityError extends RequestError {
  final ClientHttpException exception;
